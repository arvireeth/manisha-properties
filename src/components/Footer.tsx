    ...
    <footer className="relative mt-24 border-t border-[rgba(212,175,55,0.15)]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[rgba(248,244,232,0.55)] leading-relaxed">
              Your trusted real estate partner in Delhi NCR.
              DLF Channel Partner providing expert guidance for
              buying, selling, renting and property management.
            </p>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="font-serif font-semibold text-lg gold-text">
              Quick Links
            </h3>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  <Home
                    size={12}
                    className="text-[rgba(212,175,55,0.4)] group-hover:text-[#D4AF37]"
                  />
                  Home
                </Link>
              </li>
            ...
            <div className="pt-2 space-y-2">
              <h4 className="text-xs text-[rgba(248,244,232,0.5)] uppercase tracking-widest font-medium">
                Services
              </h4>
              ...
              {[
                ...
                <div
                  key={service}
                  className="flex items-center gap-2 text-xs text-[rgba(248,244,232,0.5)]"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <p className="text-sm text-[rgba(248,244,232,0.65)] leading-relaxed">
                  Block 3, Ground Floor, CSP Unit No-1
                  <br />
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="tel:8700204768"
                  className="text-sm text-[rgba(248,244,232,0.65)] hover:text-[#D4AF37]"
                >
                  +91 8700204768
                </a>
              </div>
              ...
              <div className="mt-4 p-3 rounded-xl border border-[rgba(212,175,55,0.2)] bg-[rgba(212,175,55,0.05)]">
                <div className="text-xs text-[rgba(212,175,55,0.8)] font-medium mb-1">
                  DLF Channel Partner
                </div>

                <div className="text-xs text-[rgba(248,244,232,0.5)]">
                  Authorized partner for DLF properties in Delhi NCR.
                </div>
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[rgba(248,244,232,0.4)]">
          <div>
            © {new Date().getFullYear()} Manisha Properties Advisors &
            Consultants. All rights reserved.
          </div>

          <div className="gold-text text-xs">
            Trusted Real Estate Partner in Delhi NCR
          </div>
        </div>
      </div>
    </footer>
